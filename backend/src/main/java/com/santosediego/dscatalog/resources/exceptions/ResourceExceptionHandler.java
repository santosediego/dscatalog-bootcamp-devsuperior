package com.santosediego.dscatalog.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(DatabaseException e, HttpServletRequest request) {
...
/*
 * Sempre que ocorrer em algum controlador rest alguma exceção, o tratamento da
 * exceção será tranferido para cá
 */